...
**Status: fifteen pages built, five of them validated against experiment.** The
literature survey (266 models), the Quarto scaffolding, and fifteen complete
...
| `J3.4` Doyle–Fuller–Newman P2D battery | open-circuit expression agrees with the figure's own dashed curve to 3.3 mV (tier 6) |
